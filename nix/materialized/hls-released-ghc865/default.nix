  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hie-bios".revision = (((hackage."hie-bios")."0.7.2").revisions).default;
        ...
        "hlint".revision = (((hackage."hlint")."3.2.3").revisions).default;
        ...
        "microlens-th".revision = (((hackage."microlens-th")."0.4.3.8").revisions).default;
        ...
        "ghc-lib".revision = (((hackage."ghc-lib")."8.10.3.20201220").revisions).default;
