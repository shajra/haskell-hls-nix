  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "unliftio".revision = (((hackage."unliftio")."0.2.16").revisions).default;
        ...
        "glib".revision = (((hackage."glib")."0.13.8.1").revisions).default;
        ...
        "record-dot-preprocessor".revision = (((hackage."record-dot-preprocessor")."0.2.10").revisions).default;
        ...
        "cairo".revision = (((hackage."cairo")."0.13.8.1").revisions).default;
        "cairo".flags.cairo_svg = true;
        "cairo".flags.cairo_pdf = true;
        "cairo".flags.cairo_ps = true;
        ...
        "pango".revision = (((hackage."pango")."0.13.8.1").revisions).default;
        "pango".flags.new-exception = true;
        ...
        "diagrams-cairo".revision = (((hackage."diagrams-cairo")."1.4.1.1").revisions).default;
        ...
        "tasty-hspec".revision = (((hackage."tasty-hspec")."1.1.7").revisions).default;
        ...
        "diagrams".revision = (((hackage."diagrams")."0.3").revisions).default;
