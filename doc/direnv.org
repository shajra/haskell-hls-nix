...
* Comparing Direnv/Lorelei to the HLS Nix wrapper
  ...
  getting editor feedback from HLS.  This pause isn't strictly one-time.  If you
  don't leave your editor long-running, you'll face the pause each time you
  restart your editor with a project using HLS.
